...
class Test_Random_pairs < Minitest::Test
	...
	# def test_that_names_array_returns_array_NA
	# 	assert_equal(Array, names_array("josh").class)
	# end
	# def test_that_my_names_array_returns_with_name_in_array_NA
	# 	assert_equal(["josh"], names_array("josh"))
	# end
	# def test_that_my_names_array_puts_all_names_into_array_NA
	...
	# def test_that_will_work_with_odd_number_of_names_NA
	...
	# def test_that_can_randomize_and_return_correct_number_of_subarrays_NA
	# 	names = "josh", "john", "kevin", "nick", "steve"
	# 	assert_equal(3, randomized_array(names).count)
	# end
	...
	# def test_that_returns_1_on_last_array_if_odd_number_of_names_NA
	# 	names = "josh", "john", "kevin", "nick", "steve", "travis", "trey", "phil", "jaxon"
	# 	assert_equal(1, randomized_array(names)[-1].count)
	# end
	# def test_that_can_combine_last_2_arrays_if_odd_NA
	# 	names = "josh", "john", "kevin", "nick", "steve", "travis", "trey", "phil", "jaxon"
	# 	assert_equal(3, randomized_array(names).count)
	# end
	# def test_that_can_drop_last_two_off_original_array_NA
	# 	names = "josh", "john", "kevin", "nick", "steve", "travis", "trey", "phil", "jaxon"
	# 	assert_equal(3, randomized_array(names).count)
	# end
